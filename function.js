...
but.onclick = ()=>{
   let id = inp.value
    ...
    fetch(`https://script.google.com/macros/s/AKfycbx2-1m3V_RAhqUWyMf2cXNovKnRd-ZRLAr4lNh4xicslXvHysIC3vOE1BbE6CWOSozn/exec?id=${id}`)
    .then((e) =>e.json()).then(e=>{
        
        console.log(e);
        document.getElementById("studentNum").innerHTML = "Add.NO : " + e.Details.Adno
        document.getElementById("studentName").innerHTML ="Name : " + e.Details.name
        document.getElementById("studentClass").innerHTML ="Class : " + e.Details.class
        document.getElementById("exam").innerHTML ="Name of Exam : " + e.Details.exam
        document.getElementById("sub1").innerHTML = e.Marks[0].sub
        document.getElementById("hifz1").innerHTML = e.Marks[0].P1
        ...
        document.getElementById("sub2").innerHTML = e[4]
        ...
        document.getElementById("sub3").innerHTML = e[4]
        ...
        document.getElementById("sub4").innerHTML = e[4]
        ...
        document.getElementById("sub5").innerHTML = e[4]
        ...
        document.getElementById("sub6").innerHTML = e[4]
        ...
        document.getElementById("sub7").innerHTML = e[4]
        ...
        document.getElementById("sub8").innerHTML = e[4]
        ...
        document.getElementById("sub9").innerHTML = e[4] 
        ...
        document.getElementById("sub10").innerHTML = e[4]
        ...
        document.getElementById("sub11").innerHTML = e[4]
        ...
        document.getElementById("sub12").innerHTML = e[4]
        ...
        document.getElementById("sub13").innerHTML = e[4]
